        ...
        <div class="container-lg nav-header-container">
            ...
            <div class="col-auto pe-0">
                <div class="header-social-icon d-none d-md-inline-block">
                    <a href="#" title="Facebook" target="_blank"><i class="fa-brands fa-facebook-f" aria-hidden="true"></i></a>
                    <a href="#" title="Twitter" target="_blank"><i class="fa-brands fa-twitter"></i></a>
                    <a href="#" title="Dribbble" target="_blank"><i class="fa-brands fa-dribbble"></i></a>                          
                </div>
            </div>
        </div>
    </nav>
