    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-5 col-md-6 text-center md-margin-30px-bottom wow animate__fadeInLeft">
                <iframe height="315" src="{{ asset('assets/videos/presentacion.mp4') }}" allowfullscreen load="lazy"
                    style="border-radius: 20px; width:100%;"></iframe>
            </div>
            <div class="col-lg-7 col-md-6 text-center text-md-start padding-eight-lr lg-padding-six-lr md-padding-15px-lr wow animate__fadeInRight"
                data-wow-delay="0.2s">
                ...
                <a href="{{ route('cobranza') }}"
                    class="btn btn-light-blue btn-small text-extra-small btn-rounded margin-5px-top"><i
                        ...
                        aria-hidden="true"></i> Nuestros Servicios</a>
            </div>
        </div>
    </div>
</section>
