<section class="wow animate__fadeIn bg-very-dark-gray">
    <div class="container">
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-12 text-center text-lg-start md-margin-30px-bottom md-padding-80px-lr sm-padding-15px-lr wow animate__fadeIn">
                <h5 class="alt-font font-weight-700 text-white text-uppercase w-80 lg-w-100">Descubre nuestra historia</h5>
                ...
                <p class="w-95 lg-w-100 text-white">
